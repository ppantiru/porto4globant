...
function Skills() {
  ...
  return (
    ...
    <p>After going through different types of work within the company I work for at the moment, development,
       ...
       Or the occasional "We want to... nay, we NEED to implement X" where the response often had to be "I have no clue how to do this, but I'll figure something out."
    </p>
