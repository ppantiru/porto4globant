...
function Portfolio() {
  ...
  return (
    <>
      ...
      <p>And yes, it also works on mobile.</p>
      <a className='btn btn-primary' href='https://github.com/ppantiru/TSCV/tree/globantporto' target="_blank" rel="noreferrer">Source code</a>
      <br/><br/>
      <h3>Twitter CVE to DB system</h3>
      <p>A system composed of a mongodb replica set and a worker that keeps the DB up to date with the CVE feed built with resilience in mind.</p>
      <p>The worker will continue where it left off in case of interruptions, be it the docker container goes down, the internet or the twitter API.</p>
      <img className='architecture' alt='architecture' src='twitter2cve-architecture.jpg' />
      <br/><br/>
      <a className='btn btn-primary' href='https://github.com/ppantiru/twitter-cve2db' target="_blank" rel="noreferrer">Source code</a>
      <br/><br/>
      ...
      <p>This has nothing to do with node and react, but it's more of an example of a publically available website I've worked as an architect/lead developer on, with the restriction of using the xwiki platform as a basis.
        But keep in mind this was about 5 years ago, and there are a lot of things I would probably do differently now.</p>
      <img className='demo' alt='xwiki.com' src='xcom.png' /><br/><br/>
